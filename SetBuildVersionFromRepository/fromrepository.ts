...
let maxPatchVersionRaw = tl.getInput("maxPatchVersion");
let maxPatchVersion = maxPatchVersionRaw === null || maxPatchVersionRaw === "" ? null : Number.parseInt(tl.getInput("maxPatchVersion"));
